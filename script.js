window.addEventListener('DOMContentLoaded', () => {
    ...
    header.innerHTML = `
        ...
        <nav class="header-info">
            <a href="/eng/" class="montserrat-light underline-animated">Home</a>
            <a href="/eng/info.html" class="montserrat-light underline-animated">About us</a>
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu">
                    <a href="/eng/balenciaga" class="montserrat-light underline-animated dd">Balenciaga</a>
                    <a href="/eng/rick-owens" class="montserrat-light underline-animated dd">Rick Owens</a>
                    <a href="/eng/maison-margiela" class="montserrat-light underline-animated dd">Maison Margiela</a>
                </div>
            </div>
        </nav>
        <a href="/eng/" class="logo-icon">
        ...
        <div class="header-icons">
            ...
            <a href="/eng/saved.html" class="saved-icon">
    ...
    footer.innerHTML = `
        <div class="footer-logo"><a href="/eng/"><img loading="lazy"src="/img/logotype.png" alt=""></a></div>
        <div class="footer-info">
            <a href="https://t.me/kirito_ls" class="oswald-light underline-animated-black" target="_blank">Contact us</a>
            <a href="/eng/info.html" class="oswald-light underline-animated-black">About us</a>
            <a href="/eng/" class="oswald-light underline-animated-black">Home</a>
        </div>
    ...
    mobileNav.innerHTML = `
        ...
        <a href="/eng/" class="montserrat-light">Home</a>
        <a href="/eng/info.html" class="montserrat-light">About us</a>
        <a href="https://t.me/kirito_ls" class="montserrat-light" target="_blank">Contact us</a>
        <div class="oswald-medium">brands</div>
        <a href="/eng/balenciaga" class="montserrat-light">Balenciaga</a>
        <a href="/eng/rick-owens" class="montserrat-light">Rick Owens</a>
        <a href="/eng/maison-margiela" class="montserrat-light">Maison Margiela</a>
